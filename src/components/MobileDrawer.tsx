  ...
  return (
    <>
      <div
        aria-hidden
        className={[
          'fixed inset-0 z-[80] bg-black/70 transition-opacity duration-150 lg:hidden',
      ...
      <aside
        ...
        aria-hidden={!open}
        className={[
          'fixed left-0 top-0 z-[90] flex h-full w-[min(300px,86vw)] flex-col border-r border-juxt-primary/20 bg-[#030503] shadow-[4px_0_24px_rgba(0,0,0,0.5)] transition-transform duration-150 ease-out lg:hidden',
